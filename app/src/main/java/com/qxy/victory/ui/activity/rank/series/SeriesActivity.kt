...
package com.qxy.victory.ui.activity.rank.movie.series
...
import com.qxy.victory.ui.activity.rank.series.SeriesViewModel
...
@AndroidEntryPoint
class SeriesActivity : BindingActivity<ActivitySeriesBinding>(R.layout.activity_series) {
  ...
  companion object {
    ...
    fun startActivity(transformationLayout: TransformationLayout) =
      transformationLayout.context.intentOf<SeriesActivity> {
