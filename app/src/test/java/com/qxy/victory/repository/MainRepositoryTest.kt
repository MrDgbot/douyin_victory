...
//import com.qxy.victory.model.PokemonResponse
...
//    repository = HomeRepository(client, pokemonDao, coroutinesRule.testDispatcher)
//  }
//
//  @Test
...
//    whenever(service.()).thenReturn(ApiResponse.of { Response.success(mockData) })
//
